...
${message.stack}`;
  ...
  function showDevicePicker(devices) {
    return new Promise((resolve) => {
      ...
      title.textContent = translate("shake_localsend", "\u9001\u308A\u5148\u306E\u7AEF\u672B\u3092\u9078\u3076");
      ...
      cancel.textContent = translate("shake_localsend", "\u30AD\u30E3\u30F3\u30BB\u30EB");
  ...
  registerFileAction({
    id: "shake-localsend",
    displayName: () => translate("shake_localsend", "LocalSend\u3067\u9001\u308B"),
    ...
    exec: async ({ nodes }) => {
      ...
      let devices;
      try {
        const response = await dist_default.get(generateUrl("/apps/shake_localsend/devices"));
        devices = response.data.devices;
      } catch (error) {
        toast("error", error?.response?.data?.error || translate("shake_localsend", "\u7AEF\u672B\u4E00\u89A7\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093"));
        return false;
      }
      ...
      try {
        await dist_default.post(generateUrl("/apps/shake_localsend/send"), {
          fileId: node.fileid,
        ...
        toast("error", error?.response?.data?.error || translate("shake_localsend", "\u9001\u4FE1\u306B\u5931\u6557\u3057\u307E\u3057\u305F"));
        return false;
      }
    },
    order: 26
