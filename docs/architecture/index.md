...
| 自作クラウドAPI・Terraform Provider・ポータル・CLI | API は Phase 5（セルフサービスポータル・既存VMの引き取り）まで実装し、2026-09-11 に実機で確認。Terraform Provider・CLI・VLAN分離・利用者招待は未実装。手順は[クラウドAPIの構築](../operations/cloud.md) |
